## 🛠️ Contributing to Succinct Starknet 🛠️
...
Welcome, contributing to `succinct_sn` is easy!
...
Project tracking is done via GitHub [issues](https://github.com/keep-starknet-strange/succinct-starknet/issues).
...
and voilà you're a `succinct_sn` contributor.
